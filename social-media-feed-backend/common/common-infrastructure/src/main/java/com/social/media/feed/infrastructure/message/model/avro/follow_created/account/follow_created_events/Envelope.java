 ...
 */
package follow_created.account.follow_created_events;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private follow_created.account.follow_created_events.Value before;
  private follow_created.account.follow_created_events.Value after;
   ...
   */
  public Envelope(follow_created.account.follow_created_events.Value before, follow_created.account.follow_created_events.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (follow_created.account.follow_created_events.Value)value$; break;
    case 1: after = (follow_created.account.follow_created_events.Value)value$; break;
   ...
   */
  public follow_created.account.follow_created_events.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(follow_created.account.follow_created_events.Value value) {
    this.before = value;
  }
   ...
   */
  public follow_created.account.follow_created_events.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(follow_created.account.follow_created_events.Value value) {
    this.after = value;
  }
   ...
   */
  public static follow_created.account.follow_created_events.Envelope.Builder newBuilder() {
    return new follow_created.account.follow_created_events.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static follow_created.account.follow_created_events.Envelope.Builder newBuilder(follow_created.account.follow_created_events.Envelope.Builder other) {
    if (other == null) {
      return new follow_created.account.follow_created_events.Envelope.Builder();
    } else {
      return new follow_created.account.follow_created_events.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static follow_created.account.follow_created_events.Envelope.Builder newBuilder(follow_created.account.follow_created_events.Envelope other) {
    if (other == null) {
      return new follow_created.account.follow_created_events.Envelope.Builder();
    } else {
      return new follow_created.account.follow_created_events.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private follow_created.account.follow_created_events.Value before;
    private follow_created.account.follow_created_events.Value.Builder beforeBuilder;
    private follow_created.account.follow_created_events.Value after;
    private follow_created.account.follow_created_events.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(follow_created.account.follow_created_events.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = follow_created.account.follow_created_events.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = follow_created.account.follow_created_events.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(follow_created.account.follow_created_events.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setBefore(follow_created.account.follow_created_events.Value value) {
     ...
     * @return This builder.
     */
    public follow_created.account.follow_created_events.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(follow_created.account.follow_created_events.Value.newBuilder(before));
        } else {
          setBeforeBuilder(follow_created.account.follow_created_events.Value.newBuilder());
        }
      }
    ...
    public follow_created.account.follow_created_events.Envelope.Builder setBeforeBuilder(follow_created.account.follow_created_events.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setAfter(follow_created.account.follow_created_events.Value value) {
     ...
     * @return This builder.
     */
    public follow_created.account.follow_created_events.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(follow_created.account.follow_created_events.Value.newBuilder(after));
        } else {
          setAfterBuilder(follow_created.account.follow_created_events.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public follow_created.account.follow_created_events.Envelope.Builder setAfterBuilder(follow_created.account.follow_created_events.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public follow_created.account.follow_created_events.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder setTransaction(event.block value) {
    ...
    public follow_created.account.follow_created_events.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_events.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (follow_created.account.follow_created_events.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (follow_created.account.follow_created_events.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new follow_created.account.follow_created_events.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new follow_created.account.follow_created_events.Value();
        }
