 ...
 */
package follow_created.account.follow_created_event;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private follow_created.account.follow_created_event.Value before;
  private follow_created.account.follow_created_event.Value after;
   ...
   */
  public Envelope(follow_created.account.follow_created_event.Value before, follow_created.account.follow_created_event.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (follow_created.account.follow_created_event.Value)value$; break;
    case 1: after = (follow_created.account.follow_created_event.Value)value$; break;
   ...
   */
  public follow_created.account.follow_created_event.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(follow_created.account.follow_created_event.Value value) {
    this.before = value;
  }
   ...
   */
  public follow_created.account.follow_created_event.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(follow_created.account.follow_created_event.Value value) {
    this.after = value;
  }
   ...
   */
  public static follow_created.account.follow_created_event.Envelope.Builder newBuilder() {
    return new follow_created.account.follow_created_event.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static follow_created.account.follow_created_event.Envelope.Builder newBuilder(follow_created.account.follow_created_event.Envelope.Builder other) {
    if (other == null) {
      return new follow_created.account.follow_created_event.Envelope.Builder();
    } else {
      return new follow_created.account.follow_created_event.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static follow_created.account.follow_created_event.Envelope.Builder newBuilder(follow_created.account.follow_created_event.Envelope other) {
    if (other == null) {
      return new follow_created.account.follow_created_event.Envelope.Builder();
    } else {
      return new follow_created.account.follow_created_event.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private follow_created.account.follow_created_event.Value before;
    private follow_created.account.follow_created_event.Value.Builder beforeBuilder;
    private follow_created.account.follow_created_event.Value after;
    private follow_created.account.follow_created_event.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(follow_created.account.follow_created_event.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = follow_created.account.follow_created_event.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = follow_created.account.follow_created_event.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(follow_created.account.follow_created_event.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setBefore(follow_created.account.follow_created_event.Value value) {
     ...
     * @return This builder.
     */
    public follow_created.account.follow_created_event.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(follow_created.account.follow_created_event.Value.newBuilder(before));
        } else {
          setBeforeBuilder(follow_created.account.follow_created_event.Value.newBuilder());
        }
      }
    ...
    public follow_created.account.follow_created_event.Envelope.Builder setBeforeBuilder(follow_created.account.follow_created_event.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setAfter(follow_created.account.follow_created_event.Value value) {
     ...
     * @return This builder.
     */
    public follow_created.account.follow_created_event.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(follow_created.account.follow_created_event.Value.newBuilder(after));
        } else {
          setAfterBuilder(follow_created.account.follow_created_event.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public follow_created.account.follow_created_event.Envelope.Builder setAfterBuilder(follow_created.account.follow_created_event.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public follow_created.account.follow_created_event.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder setTransaction(event.block value) {
    ...
    public follow_created.account.follow_created_event.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (follow_created.account.follow_created_event.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (follow_created.account.follow_created_event.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new follow_created.account.follow_created_event.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new follow_created.account.follow_created_event.Value();
        }
