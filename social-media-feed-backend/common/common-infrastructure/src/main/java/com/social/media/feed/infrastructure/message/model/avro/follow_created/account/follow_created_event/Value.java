...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8516496134845400868L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"follow_created.account.follow_created_event\",\"fields\":[{\"name\":\"event_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}}],\"connect.name\":\"follow_created.account.follow_created_event.Value\"}");
   ...
   */
  public static follow_created.account.follow_created_event.Value.Builder newBuilder() {
    return new follow_created.account.follow_created_event.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static follow_created.account.follow_created_event.Value.Builder newBuilder(follow_created.account.follow_created_event.Value.Builder other) {
    if (other == null) {
      return new follow_created.account.follow_created_event.Value.Builder();
    } else {
      return new follow_created.account.follow_created_event.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static follow_created.account.follow_created_event.Value.Builder newBuilder(follow_created.account.follow_created_event.Value other) {
    if (other == null) {
      return new follow_created.account.follow_created_event.Value.Builder();
    } else {
      return new follow_created.account.follow_created_event.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(follow_created.account.follow_created_event.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(follow_created.account.follow_created_event.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.event_id)) {
        this.event_id = data().deepCopy(fields()[0].schema(), other.event_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder setEventId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder clearEventId() {
      event_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public follow_created.account.follow_created_event.Value.Builder clearPayload() {
      payload = null;
